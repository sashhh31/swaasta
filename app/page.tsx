...
import { ChevronRight, Star, Heart, User, LogOut, FileText, Calendar, ClipboardList, Quote } from "lucide-react"
        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 ml-10">
              {/* Replace the login/register buttons with profile dropdown for logged in users */}
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="relative h-10 w-10 rounded-full">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-teal-800 font-medium">John Doe</span>
                      </div>
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent className="w-56" align="end" forceMount>
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/patient/orders" className="flex items-center">
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/patient/quotations" className="flex items-center">
